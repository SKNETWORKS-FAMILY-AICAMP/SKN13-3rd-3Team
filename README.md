...
특히 새로운 제품을 시도할때 실패에 대한 불안과 기회비용, 시간의 부담이 발생합니다. <br>
...
이에 우리 팀은 올리브영 스킨케어 제품에 대한 데이터 309만 건을 수집하였습니다. <br>
이를 기반으로 감성분석을 진행했고, **LLM 기반 RAG(Retrieval-Augmented Generation)** 구조로 구현된 **기초 화장품 추천 챗봇**을 구현했습니다. <br>
...
✅ 리뷰 데이터 일괄 처리 및 저장
🤗 HuggingFace에 저장 - **약 309만건**의 데이터 추출
...
우선, 올리브영 내 다른 카테고리(바디케어, 헤어케어, 색조 화장품 등)로의 확장은 데이터 구조와 메타데이터 스키마를 동일하게 적용할 수 있을 것입니다. <br>
동일한 리뷰 기반 추천 구조를 바탕으로 사용자의 다양한 니즈에 대응할 수 있습니다.<br>
