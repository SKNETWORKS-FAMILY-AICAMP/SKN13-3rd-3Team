...
✔️ 올리브영 스킨케어 제품에 대한 데이터를 크롤링해서 132만 건 수집, 감성분석을 진행하여 최종적으로 309만 건의 데이터 구축 <br>
...
### 2.2.1 ⚙️ 기술적 목표
1. 최신 리뷰 데이터 기반 RAG 챗봇, 세분화된 메타데이터로 LLM 응답 정밀도 향상
  - 올리브영 스킨케어 카테고리 사용자들의 리뷰를 크롤링
  - 9개의 메타데이터를 구성 (제품명, 성분, 별점, 피부타입, 피부고민, 자극도, 리뷰)

2. 감성 분석을 통한 리뷰 데이터 재구성
  - 한국어 리뷰를 문장 단위로 분석하여 긍정,부정,중립 감정으로 분류 - 정확하고 정밀한 응답 가능
...
<p align="left">
<img src="img/챗봇3.jpg" width="1100"/>
</p>

💬 Step 1. 질문 입력
ex) “건성 피부에 좋은 토너 추천해줘”
- 챗봇은 피부타입: 건성, 제품군: 토너를 파악하고 해당 조건을 만족하면서 리뷰 평가가 좋은 제품 3개를 추천합니다.
- 각 제품에는 주요 성분, 간단한 설명, 감성 분석 기반 요약 리뷰가 함께 제공됩니다.

💬 Step 2. 후속 질문
ex) “여기서 안 끈적거리는 제품 알려줘”
- 앞서 추천된 제품들 중 '끈적임 없음' 키워드가 많은 제품을 다시 추천합니다.

💬 Step 3. 답변 생성
ex) “세 번째 제품 바를 때 주의사항 있어?”
- 해당 제품의 부정 리뷰에서 추출한 주의 포인트를 응답합니다.
- 이처럼 챗봇은 이전 대화를 기억하고, 대화 맥락을 이어가는 방식으로 구성되어 있습니다.

✔️ 감정분석을 진행했기 때문에, 사진과 같이 부정적인 리뷰에 대해서도 확인해볼 수 있다.
...
💛이유나 : 나나입니다! 데이터가 너무 큰 나머지 많은 어려움이 있었지만 끝내고 나니 재미있었던 프로젝트였습니다! 모두 팀원들 덕이에요~<br>
💚이재범 : 뚜비입니다. 시행착오가 너무나도 많았지만, 그만큼 얻어가는 게 정말 많았습니다. 나이스한 팀원분들 만나서 자알 놀다 갑니다 🙂 <br>
❤️장진슬 : 뽀입니다,,, 진짜 힘들었어요.. 하지만 래그 너무 재밌다 또하고싶어요 그리고 우리 팀원들 진짜 최고 ❤️❤️❤️ <br>
💜지형우 : 보라돌이입니다... 제가 주제를 냈지만 밤샘 크롤링 공장, DB 갈아엎기를 겪으면서도 함께 열심히 해준 팀원분들께 감사합니다. 😂<br>
<br><br>
